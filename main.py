                                ...
                                Row(
                                    ...
                                    controls=[
                                        ...
                                        FilledButton("Encontre Areas de reciclagem em sua cidade...",
                                                     on_click=lambda: abrir_web("https://www.rotadareciclagem.com.br/"),
                                                            ...
                                                            Row(
                                                                controls=[
                                                                    Container(
                                                                        ...
                                                                        border_radius=25,
                                                                        alignment=Alignment.CENTER,
                                                                        content=Icon(Icons.RECYCLING_ROUNDED, color="#00A5FF")
                                                                    ),
                                                                    Column(
                                                                        controls=[
                                                            ...
                                                            Row(
                                                                controls=[
                                                                    Container(
                                                                        ...
                                                                        border_radius=25,
                                                                        alignment=Alignment.CENTER,
                                                                        content=Icon(Icons.RECYCLING_ROUNDED, color="#FFAA01")
                                                                    ),
                                                                    Column(
                                                                        controls=[
                                                                            Text("Separação de Materiais",
